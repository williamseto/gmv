...
match1 = [size(image_i,2)/2-pair.matches(1,:); size(image_i,1)/2-pair.matches(2,:)]';
match2 = [size(image_i,2)/2-pair.matches(3,:); size(image_i,1)/2-pair.matches(4,:)]';
showMatchedFeatures(image_i, image_j, match1, match2, 'montage');